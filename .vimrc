...
augroup MyAutoCommands
  ...
  autocmd FileType c,cpp,objc setlocal tabstop=4 shiftwidth=4 noexpandtab nowrap
  autocmd FileType coffee setlocal tabstop=4 shiftwidth=4 noexpandtab nowrap
  autocmd FileType php setlocal tabstop=4 shiftwidth=4 noexpandtab nowrap
  autocmd FileType thrift setlocal tabstop=4 shiftwidth=4 noexpandtab nowrap
  autocmd FileType ruby,eruby,haml setlocal tabstop=4 shiftwidth=4 noexpandtab nowrap
  autocmd FileType vim setlocal tabstop=4 shiftwidth=4 noexpandtab nowrap

  " Mapping file types
  autocmd BufNewFile,BufRead *.as setlocal filetype=actionscript tabstop=4 shiftwidth=4 noexpandtab nowrap
